...
/*
 * A função GRAPHrelativeNeighborhood escolhe V pontos aleatórios e de-
 * volve um grafo cujas arestas ligam pontos que estão a uma distância
 * <= D um do outro
 *                                                                   */
 ...
 * x: o k-ésimo vértice descoberto recebe número de ordem k.
