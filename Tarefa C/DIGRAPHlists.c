...
//  - Realizar buscas em profundidade
//
////////////////////////////////////////////////////////////// */
...
/* Seja U o conjunto dos vértices u tais que pre[u] >= 0. Nesse ambien-
 * te, para cada vértice x acessível a partir de v por um caminho que
 * não usa vértices de U, a função dfsR() atribui um número positivo a
